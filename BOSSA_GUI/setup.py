...
_RESOURCE_DIRECTORY = "BOSSA_GUI/resource"
...
setuptools.setup(
    ...
    project_urls = {
        "Bug Tracker" : "https://github.com/sparkfun/SparkFun_BOSSA_GUI/issues",
        "Repository"   : "https://github.com/sparkfun/SparkFun_BOSSA_GUI"
    },
    # Choose your license
    license='MIT',
    ...
    package_data={
        'BOSSA_GUI/resource': ['*.png', '*.jpg', '*.ico', '*.bin', '*.icns'],
    },
    ...
    entry_points={
        'console_scripts': ['BOSSA__GUI=BOSSA_GUI:startGUI',
        ],
    },
)
